...
const CalendarSidebar = ({ 
  ...
  return (
    <div className="p-4 h-full overflow-y-auto" role="complementary" aria-label="Painel lateral do calendário">
      {/* Mini Calendário - otimizado */}
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100" id="mini-calendar-title">
        ...
        <div className="grid grid-cols-7 gap-1 mb-2" role="row" aria-labelledby="mini-calendar-title">
        ...
        <div className="grid grid-cols-7 gap-1" role="grid" aria-labelledby="mini-calendar-title">
          {days.map((day, index) => {
